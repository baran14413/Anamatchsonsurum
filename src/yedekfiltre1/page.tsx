...
const fetchProfiles = async (
  ...
  try {
    ...
    let potentialProfiles = realUsersSnapshot.docs
      ...
      // If no real users found or deck is small, get bots to fill up
      if (potentialProfiles.length < 10) {
          ...
          const botProfiles = botsSnapshot.docs
              .map(doc => ({ ...doc.data(), id: doc.id, uid: doc.id } as UserProfile))
          ...
          potentialProfiles = [...potentialProfiles, ...botProfiles];
      }
