                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="relative">
                        ...
                        <Input type="email" placeholder={t.login.emailPlaceholder} className="pl-10 h-12 bg-secondary border-border placeholder:text-muted-foreground focus:ring-ring" {...field} />
                      </div>
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="relative">
                        ...
                        <Input type={showPassword ? 'text' : 'password'} placeholder={t.login.passwordPlaceholder} className="pl-10 pr-10 h-12 bg-secondary border-border placeholder:text-muted-foreground focus:ring-ring" {...field} />
