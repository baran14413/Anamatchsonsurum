...
export const bios = [
    ...
    "Girişimci bir ruha sahibim, her zaman yeni projeler peşindeyim.",
    "Vintage mağazaları gezmek ve eşsiz parçalar bulmak benim için bir terapi.",
    "Şiir okumayı ve yazmayı severim, kelimelerin gücüne inanırım.",
